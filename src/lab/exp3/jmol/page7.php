...
<?php if($_POST['answer']!="6" && isset($_POST['answer']))
...
jmolApplet(["300","300"],"load sample/sample6/sample6.pdb;set echo top center; font echo 13 sanserif; echo (4R,6S)-1,7-Dioxaspiro[5.5]undecan-4-ol; ")
</script>
</td>
<td>
...
<a href="page8.php"><input type="button" value="Skip"/></a>
<?php } else echo "<a href=\"page8.php\"><input type=\"submit\" value=\"Next\"/></a>";?>
