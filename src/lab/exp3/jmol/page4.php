...
<?php if($_POST['answer']!="3" && isset($_POST['answer']))
...
jmolApplet(["300","300"],"load sample/sample3/sample3.pdb;set echo top center; font echo 13 sanserif; echo (4S,6S)-1,7-Dioxaspiro[5.5]undecane-4-ol;")
</script>
</td>
<td>
