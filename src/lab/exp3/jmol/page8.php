...
jmolApplet(["300","300"],"load sample/sample1/sample1.pdb; set echo top center; font echo 13 sanserif; echo (4R,6R)-1,7-Dioxaspiro[5.5]undecane-4-ol; ")
</script>
</td>
<td>
...
<a href="page9.php"><input type="button" value="Skip"/></a>
<?php } else echo "<a href=\"page9.php\"><input type=\"submit\" value=\"Next\"/></a>";?>
