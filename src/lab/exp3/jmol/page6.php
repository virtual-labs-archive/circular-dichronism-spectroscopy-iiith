...
jmolApplet(["300","300"],"load sample/sample4/sample4.pdb;set echo top center; font echo 11 sanserif; echo (6S,9S)-9-Ethyl-l,7-dioxaspiro[5.5]undecan-4-one; ")
</script>
</td>
<td>
...
<a href="page7.php"><input type="button" value="Skip"/></a>
