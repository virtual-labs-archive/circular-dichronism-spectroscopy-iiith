...
class Application(Tk):
	...
	"""
        ...
        m1s6.add_radiobutton(label='Optical Rotatory Dispersion',command=self.m1c,variable=self.m1state,value=18)
        ...
        resolution=0.05,orient=HORIZONTAL,length=scl,command=self.w1excom,state=DISABLED)
        self.w1n=DoubleVar()
        ...
        resolution=0.05,orient=HORIZONTAL,length=scl,command=self.w2excom,state=DISABLED)
        self.w2n=DoubleVar()
    ...
    def SetupScene(self):
        ...
        while 1:
	    #print self.wwll1.get()
            rate(self.arate.get())
            wale1=self.wwll1.get()/300.0
            wale2=self.wwll2.get()/300.0
	    wale1_mod=self.wwll1.get()*(10**(-9))
            wale2_mod=self.wwll2.get()*(10**(-9))
	    ...
	    self.te.delete('1.0',END)
			...
			#self.te.insert(END,'wavelength = '+str(self.wwll1.get())+' nm\nangle of rotation = '+str( (((pi*cMatOn*( self.w1n.get()-self.w2n.get() ))/(wale1_mod*1)))%(2*pi) ) + ' rad/nm')
			self.te.insert(END,'wavelength = '+str(self.wwll1.get())+' nm\nangle of rotation = '+str( (((pi*cMatOn*( self.w1n.get()-self.w2n.get() ))/(wale1_mod*1))) *0.0000001) + ' rad/cm')
	    elif (self.w1type.get()=="Right circular") & (self.w2type.get()=="Left circular"):
			#self.te.insert(END,'wavelength = '+str(self.wwll1.get())+' nm\nangle of rotation = '+str( ((((pi*cMatOn*( self.w2n.get()-self.w1n.get() ))/(wale1_mod*1)))%(2*pi))*-1 )+' rad/nm' )
			self.te.insert(END,'wavelength = '+str(self.wwll1.get())+' nm\nangle of rotation = '+str( ((((pi*cMatOn*( self.w2n.get()-self.w1n.get() ))/(wale1_mod*1))))*-1*0.0000001 )+' rad/cm' )

	    #elif ( (t!=0.0)&((self.w1type.get()=="Left circular") & (self.w2type.get()!="Right circular") )|((self.w1type.get()=="Right circular") & (self.w2type.get()!="Left circular"))):
	    else:
